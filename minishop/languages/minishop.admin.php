...
Javascript::add('plugins/minishop/lib/js/parsley.min.js','backend',3);
Javascript::add('plugins/minishop/lib/js/i18n/'.Option::get('language').'.js','backend',3);
            ...
            switch (Request::get('action')) {
                ...
                case 'comments':
                    ...
                    if (Request::get('isSpam')) {
                        ...
                        Notification::set('success', __('Span has been clean', 'minishop'));
                ...
                case 'Js':
                    ...
                    if (Request::post('editJs')) {
                        if (Security::check(Request::post('csrf'))) {
                            ...
                            if(Request::post('ms_cashon'))$ms_cashon = Request::post('ms_cashon');
                            else $ms_cashon = Option::get('ms_cashon');
