 ...
 */
  ...
  Javascript::add('plugins/minishop/lib/js/parsley.min.js','frontend',3);
  Javascript::add('plugins/minishop/lib/js/i18n/'.Option::get('language').'.js','frontend',3);
  Javascript::add('public/assets/js/messenger.min.js','frontend',4);    
  Javascript::add('plugins/minishop/lib/js/minishop.js','frontend',5);
