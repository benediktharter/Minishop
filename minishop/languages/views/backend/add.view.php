<?php 
    echo (
    Form::open(null, array('enctype' => 'multipart/form-data','class' => 'form','data-parsley-validate')).
    ...
    <div class="from-group">
        <div class="col-md-6">
            ...
            <div class="form-group">'.
                ...
                Form::input('product', '', array('class'=>'form-control','required')).
            '</div>
            ...
            <div class="form-group">'.
                ...
                Form::input('price', '', array('class'=>'form-control','required')).
             '</div>
             <div class="form-group">'.
                Form::label('size', __('Size', 'minishop')).
                Form::input('size', '', array('class'=>'form-control','required')).
            '</div>

            <div class="form-group">'.
                Form::label('color', __('Color', 'minishop')).
                Form::input('color', '', array('class'=>'form-control','required')).
            '</div>
            <div class="form-group">'.
                Form::label('stock', __('Add stock', 'minishop')).
                Form::input('stock', '', array('class'=>'form-control','required')).
            '</div>
        </div>
