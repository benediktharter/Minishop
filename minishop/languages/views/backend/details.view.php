<?php echo  '<div class="btn-group">'.
                Html::anchor( __('Back', 'minishop'),'index.php?id=minishop&action=sales',array('class' => 'btn btn-info')).
            '</div>'.Html::br(2);
?>
...
<?php if (count($details) > 0) foreach ($details as $detail) { ?>
  ...
  <p><b> <?php echo __('Paid method','minishop'); ?>: </b> <?php echo $detail['s_paymethod'];?> </p>
