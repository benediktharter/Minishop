    ...
    $html ='<div id="shopProduct">
      ...
      $html .= '</div>
                ...
                <div class="tab-pane well" id="newComment">'.
                        ...
                        Form::open(null ,array('id' =>'ts_form','class' => 'form','data-parsley-validate')).
                        Form::hidden('ts_product',$id).

                        '<div class="form-group">'.
                            Form::label('ts_name',__('Name', 'minishop')).
                            Form::input('ts_name','',array('class'=>'form-control','required')).
                        '</div>'.


                        '<div class="form-group">'.
                            Form::label('ts_email',__('Email','minishop')).
                            Form::input('ts_email','',array('class'=>'form-control','required')).
                        '</div>
                        ...
                        '<div class="form-group">'.
                          Form::submit('ts_send',__('Save', 'minishop'), array('class' => 'btn btn-default')).
                        '</div>'.
                          Form::close().
                      '</div>'.
                '</div>';
