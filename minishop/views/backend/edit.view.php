<?php 
    ...
    echo (
    Form::open(null, array('enctype' => 'multipart/form-data',array('class' => 'form'))).
    ...
    '<div class="from-group">
        <div class="col-md-6">
            ...
            <div class="form-group">'.
                ...
                Form::input('product', $product, array('class'=>'form-control')).
            '</div>
            ...
            <div class="form-group">'.
                ...
                Form::input('price', $price, array('class'=>'form-control')).
             '</div>
             <div class="form-group">'.
                Form::label('size', __('size', 'minishop')).
                Form::input('size', $size, array('class'=>'form-control')).
            '</div>

            <div class="form-group">'.
                Form::label('color', __('color', 'minishop')).
                Form::input('color', $color, array('class'=>'form-control')).
            '</div>

            <div class="form-group">'.
                Form::label('stock', __('Add stock', 'minishop')).
                Form::input('stock', $stock, array('class'=>'form-control')).
            '</div>
    ...
    <div class="col-md-6">
            ...
            <div class="form-group">'.
                ...
                Form::input('title', $title, array('class'=>'form-control')).
            '</div>
